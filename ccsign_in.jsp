...
<meta name="csrf-token" content="SMrW7D5pv3XJ1ebfQ9EFlnHLvXYLbPfsyM6y03tBHhhFMntxqkZy5WvTFq3YAPSBjcIZtmerJCQljOA6wEniXw==" />
<meta content='text/html; charset=UTF-8' http-equiv='Content-Type'>
<meta content='initial-scale=1.0, width=device-width, maximum-scale=1.0' name='viewport'>
<meta content='IE=Edge,chrome=1' http-equiv='X-UA-Compatible'>
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","errorBeacon":"bam.nr-data.net","licenseKey":"b024d3f061","applicationID":"4029637","transactionName":"IVtaFkMOXFVcRBtBQwdGR01CBENKUFlaRx8MUUM=","queueTime":0,"applicationTime":85,"agent":""}</script>
...
<center><%out.print("You have registered successfully. Please login to continue."); %></center>
<h2>Sign In</h2>
<form class="new_user" id="new_user" action="signinaction.jsp" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="#" /><label for="user_email">Aadhar</label>
...
<input placeholder="Your Password" type="password" name="user[password]" id="user_password" required />
<input type="submit" name="commit" value="Sign In" class="button -fluid" data-working-message="Working&hellip;" />
<div class='g-row'>
...
<a href="new.html">Forgot your password?</a>
</div>
</div>
</div>
<div class='g-row'>
